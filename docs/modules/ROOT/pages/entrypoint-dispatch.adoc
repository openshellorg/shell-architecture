...
[source,mermaid]
----
include::partial$diagrams/declaration-without-dispatch.mmd[]
----
...
[source,mermaid]
----
include::partial$diagrams/honest-entrypoint-dispatch.mmd[]
----

.Official toolchain architecture
[source,mermaid]
----
include::partial$diagrams/toolchain-architecture.mmd[]
----

.Sibling ownership (DevCentr lifecycle vs OpenShellOrg dispatch)
[source,mermaid]
----
include::partial$diagrams/sibling-ownership.mmd[]
----
