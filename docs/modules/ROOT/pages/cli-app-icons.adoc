...
CLI icon badges on project-grouped manager tabs (mock discovery):
link:https://hci-nerdz.github.io/shell-context-demo/#/manager[shell-context-demo · Project manager].

image::open-terminal/cli-icons-on-manager.png[CLI app icons on vertical tab chrome in projectGroupedManager,width=100%]
