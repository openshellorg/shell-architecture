...
See xref:prompt-spatial-layout.adoc[prompt spatial layout] for 1-line / 2-line placement.
...
Detail and ASCII: xref:prompt-spatial-layout.adoc[prompt spatial layout].
Overlay-only persist (visible but stripped from copy) is **advanced later**.

== Line modes and gutter

With xref:prompt-spatial-layout.adoc[prompt spatial layout]:
...
* xref:prompt-spatial-layout.adoc[Prompt spatial layout] — 1-line / 2-line modes; gutter on input row; `▶` as type-here marker
