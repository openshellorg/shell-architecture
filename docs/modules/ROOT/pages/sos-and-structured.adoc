...
**SOS** (Standardized Operations Syntax), developed in https://github.com/openshellorg/docs[docs], addresses *how flags and options are spelled and discovered* — clarity and consistency at the CLI surface.
