...
Interactive mock (HCI-Nerdz):
link:https://hci-nerdz.github.io/shell-context-demo/#/zones[shell-context-demo · Nested zones].

image::open-terminal/layout-nested-zones.png[Contained tiling zones demo: populated monitor zone and faded empty zone,width=100%]
